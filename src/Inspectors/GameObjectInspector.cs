...
public class GameObjectInspector : InspectorBase
{
    ...
    public override GameObject CreateContent(GameObject parent)
    {
        ...
        GameObject scrollObj = UIFactory.CreateScrollView(UIRoot, "GameObjectInspector", out Content, out AutoSliderScrollbar _,
    ...
    private void ConstructLists()
    {
        ...
        TMP_Text childrenLabel = UIFactory.CreateTMPLabel(leftGroup, "ChildListTitle", "Children", TextAlignmentOptions.Center, default, false, 16);
        ...
        ButtonRef addChildButton = UIFactory.CreateTMPButton(addChildRow, "AddChildButton", "Add Child");
        ...
        TMP_Text compLabel = UIFactory.CreateTMPLabel(rightGroup, "CompListTitle", "Components", TextAlignmentOptions.Center, default, false, 16);
        ...
        ButtonRef addCompButton = UIFactory.CreateTMPButton(addCompRow, "AddCompButton", "Add Comp");
