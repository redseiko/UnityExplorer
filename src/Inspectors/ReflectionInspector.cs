...
public class ReflectionInspector : InspectorBase, ICellPoolDataSource<CacheMemberCell>, ICacheObjectController
{
    ...
    TMPInputFieldRef filterInputField;
    ...
    private void SetTarget(object target)
    {
        ...
        {
            asmText = $"{TargetType.Assembly.GetName().Name} <color=#808080FF><i>(in memory)</i></color>";
        ...
        assemblyText.text = $"<color=#808080FF>Assembly:</color> {asmText}";
    ...
    public override GameObject CreateContent(GameObject parent)
    {
        ...
        nameText = UIFactory.CreateTMPLabel(titleHolder, "VisibleTitle", "NotSet", TextAlignmentOptions.Left);
        RectTransform namerect = nameText.GetComponent<RectTransform>();
        namerect.anchorMin = Vector2.zero;
        namerect.anchorMax = Vector2.one;
        nameText.fontSize = 17f;
        ...
        makeGenericButton = UIFactory.CreateTMPButton(topRow, "MakeGenericButton", "Construct Generic", new Color(0.2f, 0.3f, 0.2f));
        ...
        dnSpyButton = UIFactory.CreateTMPButton(asmRow, "DnSpyButton", "View in dnSpy");
    ...
    void ConstructFirstRow(GameObject parent)
    {
        ...
        TMP_Text nameLabel = UIFactory.CreateTMPLabel(rowObj, "NameFilterLabel", "Filter names:", TextAlignmentOptions.Left, Color.grey);
        UIFactory.SetLayoutElement(nameLabel.gameObject, minHeight: 25, minWidth: 90, flexibleWidth: 0);

        filterInputField = UIFactory.CreateTMPInputField(rowObj, "NameFilterInput", "...");
        UIFactory.SetLayoutElement(filterInputField.UIRoot, minHeight: 25, flexibleWidth: 300);
        filterInputField.OnValueChanged += OnSetNameFilter;
        ...
        ButtonRef updateButton = UIFactory.CreateTMPButton(rowObj, "UpdateButton", "Update displayed values", new Color(0.22f, 0.28f, 0.22f));
    ...
    void ConstructSecondRow(GameObject parent)
    {
        ...
        TMP_Text scopeLabel = UIFactory.CreateTMPLabel(rowObj, "ScopeLabel", "Scope:", TextAlignmentOptions.Left, Color.grey);
    ...
    void AddScopeFilterButton(GameObject parent, BindingFlags flags, bool setAsActive = false)
    {
        ...
        ButtonRef button = UIFactory.CreateTMPButton(parent, "Filter_" + flags, lbl, color);
