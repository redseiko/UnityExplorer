...
public class GameObjectInfoPanel
{
    ...
    public void UpdateGameObjectInfo(bool firstUpdate, bool force)
    {
        ...
        if (force || Target.transform.parent != lastParentState)
        {
            ...
            if (lastParentState)
            {
                ViewParentButton.ButtonTMPText.color = Color.white;
                ViewParentButton.ButtonTMPText.text = "◄ View Parent";
            }
            else
            {
                ViewParentButton.ButtonTMPText.color = Color.grey;
                ViewParentButton.ButtonTMPText.text = "No parent";
            }
        }
        ...
        if (force || Target.scene.handle != lastSceneHandle)
        {
            ...
            SceneButton.ButtonTMPText.text = Target.scene.IsValid() ? Target.scene.name : "None (Asset/Resource)";
        }
    ...
    public void Create()
    {
        ...
        ViewParentButton = UIFactory.CreateTMPButton(firstRow, "ViewParentButton", "◄ View Parent", new Color(0.2f, 0.2f, 0.2f));
        ViewParentButton.ButtonTMPText.fontSize = 13f;
        ...
        ButtonRef copyButton = UIFactory.CreateTMPButton(firstRow, "CopyButton", "Copy to Clipboard", new Color(0.2f, 0.2f, 0.2f, 1));
        ...
        TMP_Text titleLabel =
            UIFactory.CreateTMPLabel(
                titleRow, "Title", SignatureHighlighter.Parse(typeof(GameObject), false), TextAlignmentOptions.Left, fontSize: 17);
        ...
        // InstanceID
        TMP_Text instanceIdLabel =
            UIFactory.CreateTMPLabel(secondRow, "InstanceIDLabel", "Instance ID:", TextAlignmentOptions.Right, Color.grey);
        ...
        //Tag
        TMP_Text tagLabel = UIFactory.CreateTMPLabel(secondRow, "TagLabel", "Tag:", TextAlignmentOptions.Right, Color.grey);
        ...
        // Instantiate
        ButtonRef instantiateBtn = UIFactory.CreateTMPButton(secondRow, "InstantiateBtn", "Instantiate", new Color(0.2f, 0.2f, 0.2f));
        ...
        // Destroy
        ButtonRef destroyBtn = UIFactory.CreateTMPButton(secondRow, "DestroyBtn", "Destroy", new Color(0.3f, 0.2f, 0.2f));
        ...
        ButtonRef explorerBtn = UIFactory.CreateTMPButton(thirdrow, "ExploreBtn", "Show in Explorer", new Color(0.15f, 0.15f, 0.15f));
        UIFactory.SetLayoutElement(explorerBtn.Component.gameObject, minHeight: 25, minWidth: 100);
        explorerBtn.ButtonTMPText.fontSize = 12f;
        explorerBtn.OnClick += OnExploreButtonClicked;

        // Scene
        TMP_Text sceneLabel = UIFactory.CreateTMPLabel(thirdrow, "SceneLabel", "Scene:", TextAlignmentOptions.Left, Color.grey);
        UIFactory.SetLayoutElement(sceneLabel.gameObject, minHeight: 25, minWidth: 50);

        SceneButton = UIFactory.CreateTMPButton(thirdrow, "SceneButton", "untitled");
        ...
        // Layer
        TMP_Text layerLabel = UIFactory.CreateTMPLabel(thirdrow, "LayerLabel", "Layer:", TextAlignmentOptions.Left, Color.grey);
        ...
        // Flags
        TMP_Text flagsLabel = UIFactory.CreateTMPLabel(thirdrow, "FlagsLabel", "Flags:", TextAlignmentOptions.Right, Color.grey);
