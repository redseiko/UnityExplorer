...
public static class UIManager
{
    ...
    private static void CreateTopNavBar()
    {
        ...
        string titleTxt = $"UE <i><color=#808080FF>{ExplorerCore.VERSION}</color></i>";
        TMP_Text title = UIFactory.CreateTMPLabel(navbarPanel, "Title", titleTxt, TextAlignmentOptions.Center, default, true, 14);
        ...
        closeBtn = UIFactory.CreateTMPButton(navbarPanel, "CloseButton", ConfigManager.Master_Toggle.Value.ToString());
