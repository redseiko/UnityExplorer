...
public class LogPanel : UEPanel, ICellPoolDataSource<ConsoleLogCell>
{
    ...
    protected override void ConstructPanelContent()
    {
        ...
        ButtonRef clearButton = UIFactory.CreateTMPButton(optionsRow, "ClearButton", "Clear", new Color(0.2f, 0.2f, 0.2f));
        ...
        ButtonRef fileButton = UIFactory.CreateTMPButton(optionsRow, "FileButton", "Open Log File", new Color(0.2f, 0.2f, 0.2f));
...
public class ConsoleLogCell : ICell
{
    ...
    public GameObject CreateContent(GameObject parent)
    {
        ...
        IndexLabel = UIFactory.CreateTMPLabel(UIRoot, "IndexLabel", "i:", TextAlignmentOptions.Center, Color.grey, false, 12f);
