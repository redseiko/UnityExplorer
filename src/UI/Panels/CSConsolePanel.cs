...
public class CSConsolePanel : UEPanel
{
    ...
    protected override void ConstructPanelContent()
    {
        ...
        LineNumberText = UIFactory.CreateTMPLabel(linesHolder, "LineNumbers", "1", TextAlignmentOptions.Top, Color.grey, fontSize: 16f);
        LineNumberText.font = UniversalUI.ConsoleTMPFont;
